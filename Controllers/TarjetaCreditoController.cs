...
namespace Cocoppel.Controllers
{
    ...
    public class TarjetaCreditoController : ControllerBase
    {
        ...
        public TarjetaCreditoController(CocoppelContext context)
        {
            _context = context;
        }
        ...
        {
            if (id != tarjetaCredito.IdlineaCredito)
            {
                return BadRequest();
            }
        ...
        public async Task<ActionResult<TarjetaCredito>> PostTarjetaCredito(TarjetaCredito tarjetaCredito)
        {
            ...
            {
                if (TarjetaCreditoExists(tarjetaCredito.IdlineaCredito))
                {
                    return Conflict();
                }
                else
            ...
            return CreatedAtAction("GetTarjetaCredito", new { id = tarjetaCredito.IdlineaCredito }, tarjetaCredito);
        }
        ...
        {
            return _context.TarjetaCredito.Any(e => e.IdlineaCredito == id);
        }
    }
}
